...
@section('content')
    ...
    {{-- headline text --}}
    <h1 class="text-hacklab_green font-bold font-display text-2xl mt-10 ml-4 mb-6">Hacklab {{ __('nieuwe account') }}</h1>
    ...
    <form class="bg-gray-900/50 ml-4 border-none block w-5/12 h-6/6 pb-1" name="create_user_form" method="POST"
        ...
        <h2 class="text-white text-3xl pl-4 pt-10">{{ __('Gebruiker toevoegen') }}</h2><br>
        @csrf
        ...
        <input
            ...
            type="text" name="name" id="name" placeholder="{{ __('Naam') }}" string required>
        ...
        <input
            ...
            border-2 border-gray-400 focus:border-none rounded-sm focus:ring-hacklab_green focus:outline-1
            outline-hacklab_green placeholder-gray-400 focus:placeholder-hacklab_green"
            type="email" name="email" id="email" placeholder="{{ __('E-mailadres') }}" string required>
        ...
        <input
            ...
            border-2 border-gray-400 focus:border-none rounded-sm focus:ring-hacklab_green focus:outline-1
            outline-hacklab_green placeholder-gray-400 focus:placeholder-hacklab_green"
            type="tel" name="phone_number" id="phone_number" placeholder="{{ __('Telefoonnummer') }}">

        {{-- date of birth input field --}}
        <label class="text-white ml-4 mb-0">{{ __('Geboorte datum') }}
            <input
        ...
        <input
            ...
            border-2 border-gray-400 focus:border-none rounded-sm focus:ring-hacklab_green focus:outline-1
            outline-hacklab_green placeholder-gray-400 focus:placeholder-hacklab_green"
            type="text" name="hometown" id="hometown" placeholder="{{ __('Woonplaats') }}" required>

        {{-- start date input field --}}
        <label class="text-white ml-4 mb-0">{{ __('Start datum') }}
            <input
                class="bg-gray-500/50 text-white focus:ring-1 focus:outline-none p-3 mt-0 mb-6 block w-96 m-4
            border-2 border-gray-400 focus:border-none rounded-sm focus:ring-hacklab_green focus:outline-1
            outline-hacklab_green"
        ...
        <label for="loan_Equipment" class="text-white ml-4 mb-6">{{ __('Heeft een laptop nodig') }}</label>
